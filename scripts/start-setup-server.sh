...
echo ""
echo "─────────────────────────────────────────────────────────────────"
echo "PRE pokretanja daemon-a — opciono editujes yaml-ove ako treba:"
echo "─────────────────────────────────────────────────────────────────"
echo ""
echo "  ${EDITOR:-nano} $HOME/clade-agent/ceo.yaml          # role, name"
echo "  ${EDITOR:-nano} $HOME/clade-agent/frontend.yaml     # role, extra_add_dirs"
echo ""
echo "Najcesce trazeno: extra_add_dirs (v1.10.2) — putanje koje daemon-spawn"
echo "Claude moze da cita van svog workdir-a (npr project root, /var/www, ...)"
echo ""
echo "  # u <peer>.yaml dodaj na vrh ili dno:"
echo "  extra_add_dirs:"
echo "    - $HOME/projects/foo"
echo "    - /var/www/myapp"
echo ""
echo "Daemon ucita yaml na startup-u, pa edit vazi za sledeci start-<peer>.sh."
echo "─────────────────────────────────────────────────────────────────"
echo ""
